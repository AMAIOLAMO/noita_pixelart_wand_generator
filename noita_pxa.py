...
def make_pixel_str(is_col_end: bool, color_spell_name: str, inf_mana: bool = False) -> str:
    ...
    result += "NOLLA,SUPER_TELEPORT_CAST,BURST_3,ZERO_DAMAGE,ZERO_DAMAGE," + color_spell_name + ",FIREBOMB,ADD_TRIGGER,CASTER_CAST,DIGGER,PURPLE_EXPLOSION_FIELD,SUPER_TELEPORT_CAST"
    ## too laggy
...
for x in range(width):
    spell_str_io.write(",")
    spell_str_io.write(begin_column_str(is_inf_mana))
    spell_str_io.write("\n")
    ...
    for y in range(height):
        ...
        spell_str_io.write(",")
        spell_str_io.write(make_pixel_str(is_end, match_color_spell_name, is_inf_mana))
...
if args.preview != None:
    ...
    print("Saving preview to file: " + args.preview)
